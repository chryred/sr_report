...
# ── 프로젝트별 문의유형 매핑 방식 분기 ────────────────────
# 차세대 프로젝트: 업무유형(FTE) 단독 기반(차세대 방식)으로 매핑
# 그 외 프로젝트: 업무구분(FTE) 기반(신 방식)으로 매핑
FTE_NEXTGEN_MAPPING_PROJECTS = [
    "백화점DX팀 업무 관리",
    "신세계SAP팀 업무 관리",
]

# 차세대 방식: 업무유형(FTE) → 문의유형 (차세대 프로젝트 전용)
FTE_TYPE_TO_INQUIRY_TYPE = {
    "DB 작업 및 관리":       "3. 데이터 추출 및 수정",
    "개발환경 셋팅":         "5. 운영관리(시스템/품질/보안/감사)",
    ...
    "문서 작성":             "2. 단순조치/운영지원",
    "문의 대응":             "2. 단순조치/운영지원",
    "서버 작업 및 관리":     "5. 운영관리(시스템/품질/보안/감사)",
    "시스템 분석":           "5. 운영관리(시스템/품질/보안/감사)",
    "시스템 점검/모니터링":  "5. 운영관리(시스템/품질/보안/감사)",
    "신규개발":              "4. 신규개발 및 개선",
    "업무 보고/회의":        "5. 운영관리(시스템/품질/보안/감사)",
    "영향도 검토":           "5. 운영관리(시스템/품질/보안/감사)",
    "오류 처리":             "2. 단순조치/운영지원",
    "오류수정":              "2. 단순조치/운영지원",
    "외주 유지보수 관리":    "5. 운영관리(시스템/품질/보안/감사)",
    "월마감":                "2. 단순조치/운영지원",
    "일부개발":              "4. 신규개발 및 개선",
    "장애예방활동":          "5. 운영관리(시스템/품질/보안/감사)",
    "점포 운영":             "5. 운영관리(시스템/품질/보안/감사)",
    "점포 장비 관리":        "5. 운영관리(시스템/품질/보안/감사)",
    "정보보안 대응":         "5. 운영관리(시스템/품질/보안/감사)",
    "품질 강화":             "5. 운영관리(시스템/품질/보안/감사)",
    "프로젝트 관리":         "5. 운영관리(시스템/품질/보안/감사)",
    "프로젝트 지원/대응":    "5. 운영관리(시스템/품질/보안/감사)",
    "감사대응":              "5. 운영관리(시스템/품질/보안/감사)",
    "점포 오픈/리뉴얼/폐점 대응": "2. 단순조치/운영지원",
}

# 신 방식: 업무구분(FTE) → 문의유형 기본 매핑
# ※ "일반 업무"는 업무유형(FTE)에 따라 세분화하므로 이 딕셔너리에서 제외
FTE_DIVISION_INQUIRY_MAP = {
    "데이터 작업":               "3. 데이터 추출 및 수정",
    "프로그램개선/개발":         "4. 신규개발 및 개선",
    "운영 업무":                 "5. 운영관리(시스템/품질/보안/감사)",
    "품질관리":                  "5. 운영관리(시스템/품질/보안/감사)",
    "프로젝트 지원/관리":        "5. 운영관리(시스템/품질/보안/감사)",
    "IT 운영 사업 기획 및 관리": "5. 운영관리(시스템/품질/보안/감사)",
...
# 업무구분(FTE)이 없을 때 이슈 유형 기반으로 문의유형을 결정하는 매핑
# 예: 이슈 유형이 "변경관리"이고 업무구분이 없으면 → "4. 신규개발 및 개선"
